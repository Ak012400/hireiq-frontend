...
function PdfTools() {
  ...
  const buildResumeHtml = async (text, instruction, photo) => {
    ...
    const prompt = `Generate a COMPLETE professional HTML resume with inline CSS.
  ...
  Design Requirements:
  - Full page layout A4 style
  - Dark gradient header (#0f0c29 to #302b63)
  - TWO column layout: left sidebar 35% + right main 65%
  - LEFT sidebar: use exactly this placeholder for photo: <img id="resume-photo" src="PHOTO_PLACEHOLDER" style="width:90px;height:90px;border-radius:50%;object-fit:cover;border:3px solid rgba(255,255,255,0.4);margin-bottom:12px;" />, name, role, contact info, skills as colored pill tags, education
  - RIGHT main: professional summary highlighted bar, experience with bullet points, projects, extra sections
  - Skill tags: inline-block, rounded, light purple background
  - Clean modern typography, proper line spacing
  - Footer: "⚡ Generated by HireIQ AI Studio by Arun Kumar"
